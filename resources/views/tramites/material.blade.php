    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content px-3 pb-0">
            ...
            <div class="modal-body " style="display: flex;align-items-left">
                <form class="form-horizontal" role="form" method="POST" action="{{ route('material-store') }}" enctype="multipart/form-data" id="form-nuevo">
                    @csrf
                    <div class="row text-center">
                        <div class="col-md-5">
                            <div class="form-group">
                                <label for="ASUNTO">ASUNTO:</label>
                                <select class=" form-control col" name="asunto" id="asuntos" onchange="mostrar(this.value)" required>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="card-body">
                            <div class="row form-group" id="materiales">
                                <div class="material row ">
                                    ...
                                    <div class="col-md-5 p-2">
                                        <input id="serial" class="form-control " type="text" name="serials[]" style="text-transform: uppercase;" placeholder="serial" required />
                                    </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header" style="text-align:left;">
                    ...
                    <button class=" d-inline btn btn-info float-right shadow " id="btn-creacion" data-toggle="modal" data-target="#creacion" name="Agregar Producto">
